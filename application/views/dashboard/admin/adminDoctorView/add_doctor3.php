<div class="content">
  <div class="animated fadeIn">
    ...
    <div class="row form-group">
        <div class="col col-md-4"><label for="retype-password" class="form-control-label">Confirm Password</label>
        </div>
        <div class="col-12 col-md-8"><input type="password" name="retype-password" placeholder="Confirm Password" class="form-control">
