...
<head>
    ...
    <meta name="description" content="Med+ Admin">
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active">
                        <a href="isLoggedIn"><i class="menu-icon fa fa-laptop"></i>Dashboard </a>
                    </li>
                    <!-- <li class="menu-title">Hospital</li> -->
                    <!-- /.menu-title -->
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-puzzle-piece"></i><a href="hospital_view">View hospitals</a></li>
                            <li><i class="fa fa-id-badge"></i><a href="add_hospital">Add hospital</a></li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-table"></i><a href="tables-basic.html">View doctors</a></li>
                            <li><i class="fa fa-table"></i><a href="tables-data.html">Add doctors</a></li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-th"></i><a href="forms-basic.html">View patients</a></li>
                            <li><i class="menu-icon fa fa-th"></i><a href="forms-advanced.html">Add patients</a></li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-fort-awesome"></i><a href="font-fontawesome.html">View appointments</a></li>
                            <li><i class="menu-icon ti-themify-logo"></i><a href="font-themify.html">New appointment</a></li>
                            <li><i class="menu-icon ti-themify-logo"></i><a href="font-themify.html">Cancel appointment</a></li>
                        </ul>
                    </li>
                    <!-- <li>
                    ...
                    <!-- <li class="menu-title">Patient</li> --><!-- /.menu-title -->
                    <!-- <li class="menu-item-has-children dropdown">
