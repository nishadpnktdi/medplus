...
<head>
    ...
    <link rel="apple-touch-icon" href="<?php echo base_url() ?>assets/admin/images/logo4.png">
    <link rel="shortcut icon" href="<?php echo base_url() ?>assets/admin/images/logo4.png">
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active">
                        <a href="<?php echo base_url();?>/admin/admin"><i class="menu-icon fa fa-laptop"></i>Dashboard </a>
                    </li>
